...
public class OrderedVectorOfContacts implements ContactBook {
    ...
    //Default constructor
    public OrderedVectorOfContacts() {
    ...
    public OrderedVectorOfContacts(int inCapacity) {
    ...
    public void addContact(Contact c) {
        ...
        //Sorting by ascending phone number
        int i;
        boolean flag = true;
        ...
        while (flag) {
            ...
            for (i = 0; i < size - 1; i++) {
                if (contacts[i].getPhoneNumber() > contacts[i + 1].getPhoneNumber()) {
                    temp_contact = contacts[i];
                    contacts[i] = contacts[i + 1];
                    contacts[i + 1] = temp_contact;
                    flag = true;
                }
            }
        }
